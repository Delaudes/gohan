...
type RecipesProps = {
    ...
    isSuccessCreatingRecipe: boolean;
...
export class RecipesViewModel {
    ...
    readonly isSuccessCreatingRecipe: boolean;
    ...
    constructor(props: RecipesProps) {
        ...
        this.isSuccessCreatingRecipe = props.isSuccessCreatingRecipe;
