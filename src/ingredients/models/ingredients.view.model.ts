...
type IngredientsProps = {
    ...
    isSuccessCreatingIngredient: boolean;
...
export class IngredientsViewModel {
    ...
    readonly isSuccessCreatingIngredient: boolean;
    ...
    constructor(props: IngredientsProps) {
        ...
        this.isSuccessCreatingIngredient = props.isSuccessCreatingIngredient;
    ...
    static initial(): IngredientsViewModel {
        return new IngredientsViewModel({
            ...
            isSuccessCreatingIngredient: false,
            ingredients: [],
            searchQuery: '',
        });
    }
    ...
    presentIngredientCreated(ingredient: IngredientViewModel): IngredientsViewModel {
        return this.with({
            ...
            isSuccessCreatingIngredient: true,
        });
    }
