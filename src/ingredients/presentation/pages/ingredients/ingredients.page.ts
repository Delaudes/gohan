...
import { ToggleShoppingListComponent } from '../../components/toggle-shopping-list/toggle-shopping-list.component';
import { INGREDIENTS_PROVIDERS } from '../../ingredients.provider';

@Component({
  selector: 'app-ingredients',
  imports: [DeleteIngredientComponent, CreateIngredientComponent, ToggleShoppingListComponent],
