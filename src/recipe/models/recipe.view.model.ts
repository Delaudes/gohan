...
type RecipeProps = {
    ...
    isSuccessAddingIngredient: boolean;
...
export class RecipeViewModel {
    ...
    readonly isSuccessAddingIngredient: boolean;
    ...
    constructor(props: RecipeProps) {
        ...
        this.isSuccessAddingIngredient = props.isSuccessAddingIngredient;
    ...
    static initial(): RecipeViewModel {
        return new RecipeViewModel({
            ...
            isSuccessAddingIngredient: false,
